            ...
            <div class="col-md-12">
                ...
                <form method="post" action={{url("save-student")}}>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="class" class="form-control" id="class" placeholder="Enter your class" value={{old('class')}}>
                    </div>
                    @error('class')
                    <div class="alert alert-danger">{{$message}}</div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="age" class="form-control" id="age" placeholder="Enter your age" value={{old('age')}}>
                    </div>
                    @error('age')
                    <div class="alert alert-danger">{{$message}}</div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="phone" class="form-control" id="phone" placeholder="Enter your number" value={{old('phone')}}>
                    </div>
                    @error('phone')
                    <div class="alert alert-danger">{{$message}}</div>
